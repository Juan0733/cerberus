...
<main id="gran_padre_funcionario">
    <section id="contenedor_ppal_funcionario">
        <header id="contenedor_titulo_form">
            <div class="" id="cont_title">
                <h1 id="title_logo">Registro Funcionario</h1>
                <h3 id="subtitle_logo">Bienvenido al CAB, por favor registrate</h3>
            </div>
        </header>
        <div id="contenedor_formulario_funcionario">
            <form id="formulario_funcionario" method="post">
                <div id="caja_01" class="caja">
                    ...
                    <div class="input-caja-registro">
                        ...
                        <input type="text" inputmode="numeric" class="campo campo-seccion-01" name="numero_documento" id="numero_documento" pattern="[A-Za-z0-9]{6,15}" title="Debes digitar solo números y/o letras, mínimo 6 y máximo 15 caracteres" placeholder="Ej: 123456Dil" tabindex="2" >
                    </div>
                ...
                <div id="contenedor_btns_funcionario">
                    <button type="button" id="btn_atras_funcionario">
                        <ion-icon name="chevron-back-outline"></ion-icon>
                    </button>
                    <button type="button" id="btn_siguiente_funcionario">Siguiente</button>
                    <button type="submit" id="btn_registrarme_funcionario">Registrarme</button>
                </div>
            </form>
        </div>
    </section>
