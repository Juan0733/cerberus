<div class="contenedor-titulo-modal">
    <h2 id="titulo_modal_actualizar_contrasena" class="titulo-modal">Actualizar Contraseña</h2>
    <ion-icon name="close-outline" id="cerrar_modal_actualizar_contrasena" class="close-btn"></ion-icon>
</div>
<div class="contenedor-info-modal">
    <div id="cont_info_modales">
        <form action="" id="formulario_actualizar_contrasena" method="post" >
           <div id="contenedor_cajas_habilitar">
            ...
            <div id="contenedor_btns_actualizar_contrasena">
                <button type="button" id="btn_cancelar_actualizacion">Cancelar</button>
