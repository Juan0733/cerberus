...
async function consultarBrigadistas(urlBase) {
    try {
        contenedorSpinner.classList.add("mostrar_spinner");
        const response = await fetch(urlBase+'app/controllers/FuncionarioController.php?operacion='+encodeURI('consultar_brigadistas'), {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
            }
...
export{consultarBrigadistas}

async function consultarFuncionarios(parametros, urlBase) {
    try {
        contenedorSpinner.classList.add("mostrar_spinner");
        const response = await fetch(urlBase+'app/controllers/FuncionarioController.php?operacion='+encodeURI('consultar_funcionarios')+'&brigadista='+encodeURI(parametros.brigadista)+'&ubicacion='+encodeURI(parametros.ubicacion)+'&documento='+encodeURI(parametros.documento)+'&rol='+encodeURI(parametros.rol)+'&cantidad='+encodeURI(parametros.cantidad), {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
            }
