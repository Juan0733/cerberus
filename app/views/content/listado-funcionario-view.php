  ...
  <div id="cont_opciones_listado">
        ...
        <div class="cont_buscar_persona">
          <div class="buscar">
            ...
            <input type="hidden" id="url" value="<?php echo APP_URL_BASE;?>/app/ajax/funcionario-ajax.php" >
          </div>
...
<script src="<?php echo APP_URL_BASE; ?>app/views/js/listado-funcionario.js"></script>
