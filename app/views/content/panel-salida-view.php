    ...
    <div class="contenedor-card-ptn-vhl">
        ...
        <div class="cont_entrada_salida_01 cont_e_s cont-entr-sali-peatonal">
            ...
            <form action="<?php echo APP_URL_BASE; ?>app/ajax/ingreso-ajax.php" method="post" id="form_entr" class="formulario-ingreso-salida" >
                <input type="hidden" name="modulo_ingreso" value="salida_peatonal_registro" >
                ...
                <div class="cont_cajas_ptn">
                    <div class="input-caja">
                        ...
                        <textarea class="campo" inputmode="numeric" name="observaciones" id="observaciones" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚüÜ0-9]{6,15}" title="Debes digitar solo numeros y como minimo 6 numeros y maximo 10 numeros" placeholder="Escribe aquí..." tabindex="4" ></textarea>
                    </div>
                    <div class="input-caja">
    ...
    <div class="contenedor_ppal_reporte">
        ...
        <div id="contenedor_tabla">
            ...
            <table class="table">
                ...
                <tbody class="body-table" id="lista_reportes">
