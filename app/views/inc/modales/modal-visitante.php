        ...
        <form action="" id="formulario_visitante" method="post" >
            <div id="contenedor_cajas_visitante">
                ...
                <div class="input-caja-registro seccion-01">
                    ...
                    <input type="text" class="campo campo-seccion-01" name="documento_visitante" id="documento_visitante"  pattern="[A-Za-z0-9]{6,15}" title="Debes digitar solo números y como mínimo 6 numeros y máximo 15 numeros" placeholder="Ej: 123456Dil" date="Numero de documento" tabindex="9" required>
                </div>
                ...
                <div class="input-caja-registro seccion-02">
                    ...
                    <input class="campo" type="text" name="motivo_ingreso" id="motivo_ingreso" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚüÜ0-9., ]{5,150}" maxlength="100" minlength="5" list="lista_motivos" placeholder="Ej: Matricula" title="Debes digitar solo letras y números, mínimo 5 y máximo 100 caracteres." tabindex="7" date="Motivo ingreso" required>
