            ...
            <form id="formulario_aprendiz" method="post">
                ...
                <div id="caja_02" class="caja">
                    ...
                    <div class="input-caja-registro">
                        ...
                        <input type="text" class="campo" name="numero_ficha" id="numero_ficha" list="lista_fichas" pattern="[0-9]{7}" title="Debes digitar solo números, mínimo y máximo 8" placeholder="Ej: 1234567" maxlength="7" minlength="7" tabindex="7" required>
