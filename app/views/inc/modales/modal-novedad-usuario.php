        ...
        <form  id="formulario_novedad_usuario" method="post" >
            <div id="contenedor_cajas_novedad_usuario" >
                ...
                <div class="input-caja-registro">
                    ...
                    <input type="text" class="campo" name="documento_involucrado" id="documento_involucrado" pattern="[A-Za-z0-9]{6,15}" title="Debes digitar solo números y/o letras, mínimo 6 y máximo 15 caracteres" placeholder="Ej: 123456" date="Numero de documento" tabindex="5" required>
                </div>
