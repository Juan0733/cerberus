  ...
  <div id="cont_opciones_listado">
        ...
        <div class="cont_buscar_persona">
          <div class="buscar">
            ...
            <input type="hidden" id="url" value="<?php echo APP_URL_BASE;?>/app/ajax/vigilanteAjax.php" >
          </div>
...
<script src="<?php echo APP_URL_BASE; ?>app/views/js/listado-vigilantes.js"></script>
