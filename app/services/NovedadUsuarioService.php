...
class NovedadUsuarioService{
    public function sanitizarDatosNovedadUsuario(){
        if (!isset($_POST['documento_causante'], $_POST['tipo_novedad'], $_POST['fecha_suceso'], $_POST['puerta_suceso'], $_POST['descripcion']) || $_POST['documento_causante'] == '' || $_POST['tipo_novedad'] == '' || $_POST['fecha_suceso'] == '' || $_POST['puerta_suceso'] == '' || $_POST['descripcion'] == '') {
            $respuesta = [
                "tipo" => "ERROR",
        ...
        $numeroDocumento = $this->limpiarDatos($_POST['documento_causante']);
        ...
        unset($_POST['documento_causante'], $_POST['tipo_novedad'], $_POST['fecha_suceso'], $_POST['puerta_suceso'], $_POST['descripcion']);
