                ...
                <div class="contenedor_de_cajas">
                    <div id="caja_01_registro" class="rotado rotado caja_02_registro_03">
                        ...
                        <div class="input-caja-registro">
                            ...
                            <input type="text" class="campo  validacion-campo-03" inputmode="numeric" name="propietario" id="propietario" pattern="[A-Za-z0-9]{6,15}" title="Debes digitar solo numeros y letras, minimo 6 y maximo 15 caracteres" placeholder="Ej: 123456" tabindex="4" required>
                        </div>
